...
int main()
{
	...
	//ModelAnim CarroClasico01("resources/objects/Carro01_Clasico/Carro01_Clasico.dae");
	//CarroClasico01.initShaders(animShader.ID);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//// -------------------------------------------------------------------------------------------------------------------------
		//// Carro Clasico 1 Animacion
		//// -------------------------------------------------------------------------------------------------------------------------
		//model = glm::translate(glm::mat4(1.0f), glm::vec3(40.3f, 1.75f, 0.3f)); // translate it down so it's at the center of the scene
		//model = glm::scale(model, glm::vec3(0.5f));	// it's a bit too big for our scene, so scale it down
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		//animShader.setMat4("model", model);
		//CarroClasico01.Draw(animShader);
		...
		// Base CCC1
		// -------------------------------------------------------------------------------------------------------------------------
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-400.0f, 0.0f, 80.0f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		staticShader.setMat4("model", model);
		staticShader.setVec3("dirLight.specular", glm::vec3(0.77f, 0.77f, 0.77f));
		...
		//model = glm::translate(tmp, glm::vec3(0.0f, 0.0f, 50.0f));
		//model = glm::scale(model, glm::vec3(10.0f, 10.0f, 10.0f));
		//staticShader.setMat4("model", model);
		//carroceriaCarro02.Draw(staticShader);	//Carroceria

		//model = glm::translate(tmp, glm::vec3(0.0f, 30.0f, 50.0f));
		//model = glm::scale(model, glm::vec3(10.0f, 10.0f, 10.0f));
		//staticShader.setMat4("model", model);
		//interioresCarro02.Draw(staticShader);	//Interiores
